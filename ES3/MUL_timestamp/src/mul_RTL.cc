...
void mul_RTL :: elaborate_mul_FSM(void){
  cout<<"\t"<<sc_time_stamp()<<" - mul: SQRT_FSM"<<endl;
	...
	if (reset.read() == 0){
	    cout<< "\t" <<sc_time_stamp()<< " - mul: reset" << endl;
		STATUS = SR;
	}
	else if (clk.read() == 1) {
		...
		case SR:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: SR" << endl;
			out_result.write(0);
		...
		case S0:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S0" << endl;
			out_result.write(0);
			result_isready.write(0);
			...
			//leggo i numeri
		case S0I:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: SOI" << endl;
			...
			//sommo gli esponenti
		case S1:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S1" << endl;
		...
		case S2:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S2" << endl;
		...
		case S3:
			if(counter <= 52){
			    cout<< "\t" <<sc_time_stamp()<< " - mul: S3" << endl;
				end_mantissa.write(false);
			}
			else
		...
		case S31:
			...
			if(mantissa2[counter] == '1') {
			    cout<< "\t" <<sc_time_stamp()<< " - mul: S31" << endl;
		...
		case S4:
		    ...
		    cout<< "\t" <<sc_time_stamp()<< " - root: S4" << endl;
			...
			//overflow?
		case S5:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S5" << endl;
		...
		case S7:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S7" << endl;
			...
			//calcolo del segno
		case S8:
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S8" << endl;
		...
		case S9:
		    ...
		    cout<< "\t" <<sc_time_stamp()<< " - mul: S9" << endl;
